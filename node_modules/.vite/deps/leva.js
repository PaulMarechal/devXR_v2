...
var require_extend_shallow2 = __commonJS({
  "../../../node_modules/set-value/node_modules/extend-shallow/index.js"(exports, module) {
    "use strict";
...
var commonConfigResolver = {
  ...
  transform(value, _k, config) {
    ...
    if (true) {
      ...
      return (v5) => {
        const r17 = originalTransform(v5);
        if (!isFinite(r17[0]) || !isFinite(r17[1])) {
          console.warn(`[@use-gesture]: config.transform() must produce a valid result, but it was: [${r17[0]},${[1]}]`);
        }
        return r17;
      };
    }
...
function resolveWith(config = {}, resolvers) {
  ...
  for (const [key, resolver] of Object.entries(resolvers)) {
    switch (typeof resolver) {
      case "function":
        if (true) {
          const r17 = resolver.call(result, config[key], key, config);
          if (!Number.isNaN(r17))
            result[key] = r17;
        } else {
...
var clamp2 = (x4, min, max) => x4 > max ? max : x4 < min ? min : x4;
var parseNumber = (v5) => {
...
function ValueInput(_ref) {
  ...
  return import_react3.default.createElement(InputContainer, {
    textArea: isTextArea
  }, innerLabel && typeof innerLabel === "string" ? import_react3.default.createElement(InnerLabel, null, innerLabel) : innerLabel, import_react3.default.createElement(StyledInput, _extends2({
    levaType: type,
    ref: inputRef,
    id: inputId,
    type: inputType,
...
function NumberInput(_ref2) {
  ...
  const _onUpdate = (0, import_react3.useCallback)((v5) => onUpdate(parseNumber(v5)), [onUpdate]);
  ...
  return import_react3.default.createElement(ValueInput, _extends2({}, props3, {
    onUpdate: _onUpdate,
    onKeyDown,
    type: "number"
  }));
...
function RawLabel(props3) {
  ...
  return import_react3.default.createElement(import_react3.default.Fragment, null, optional2 && import_react3.default.createElement(OptionalToggle, null), hint !== void 0 ? import_react3.default.createElement(Root5, null, import_react3.default.createElement(Trigger, {
    asChild: true
  }, import_react3.default.createElement(StyledLabel, _extends2({}, htmlFor, props3))), import_react3.default.createElement(Content2, {
    side: "top",
    sideOffset: 2
  }, import_react3.default.createElement(StyledToolTipContent, null, hint, import_react3.default.createElement(ToolTipArrow, null)))) : import_react3.default.createElement(StyledLabel, _extends2({}, htmlFor, title, props3)));
}
function Label(_ref) {
  let {
    align
...
function Chevron(_ref) {
  ...
  return import_react3.default.createElement(Svg, _extends2({
    width: "9",
    height: "5",
    viewBox: "0 0 9 5",
    xmlns: "http://www.w3.org/2000/svg",
...
function useInputSetters({
  ...
  const setFormat = (0, import_react3.useCallback)((v5) => setDisplayValue(format$2(type, v5, settingsRef.current)), [type]);
...
function RangeSlider({
  ...
  return import_react3.default.createElement(RangeWrapper, _extends2({
    ref
...
var DraggableLabel = import_react3.default.memo(({
  ...
  return import_react3.default.createElement(InnerNumberLabel, _extends2({
    dragging,
...
function NumberComponent() {
  ...
  return import_react3.default.createElement(Row, {
    ...
    hasRange
  }, hasRange && import_react3.default.createElement(RangeSlider, _extends2({
    value: parseFloat(value),
    onDrag: onUpdate
  }, settings)), import_react3.default.createElement(Number$1, _extends2({}, props3, {
    id,
    label: "value",
...
function Select({
  ...
  return import_react3.default.createElement(SelectContainer, null, import_react3.default.createElement(NativeSelect, {
    ...
    disabled
  }, keys.map((key, index) => import_react3.default.createElement("option", {
    key,
    value: index
...
function String$1(_ref) {
  ...
  if (editable)
    return import_react3.default.createElement(ValueInput, _extends2({
      value: displayValue,
      onUpdate,
      onChange
    }, props3));
...
function StringComponent() {
  ...
  return import_react3.default.createElement(Row, {
    input: true
  }, import_react3.default.createElement(Label, null, label), import_react3.default.createElement(String$1, _extends2({
    displayValue,
    onUpdate,
    onChange
  }, settings)));
...
function Vector({
  ...
  }), Object.keys(value).map((key, i6) => import_react3.default.createElement(Coordinate, {
    id: i6 === 0 ? id : `${id}.${key}`,
    key,
    valueKey: key,
    value,
...
function i5(e12) {
  var t12 = (0, import_react6.useRef)(e12), n6 = (0, import_react6.useRef)(function(e13) {
...
var m4 = import_react6.default.memo(function(o12) {
  var a5 = o12.onMove, l6 = o12.onKey, s6 = c5(o12, ["onMove", "onKey"]), m5 = (0, import_react6.useRef)(null), g5 = i5(a5), p5 = i5(l6), b5 = (0, import_react6.useRef)(null), _3 = (0, import_react6.useRef)(false), x4 = (0, import_react6.useMemo)(function() {
  ...
  return (0, import_react6.useEffect)(function() {
    return H3;
  }, [H3]), import_react6.default.createElement("div", u4({}, s6, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m5, onKeyDown: E3, tabIndex: 0, role: "slider" }));
});
var g4 = function(e12) {
...
var p4 = function(r17) {
  ...
  return import_react6.default.createElement("div", { className: l6, style: { top: 100 * a5 + "%", left: 100 * n6 + "%" } }, import_react6.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t12 } }));
};
...
var S3 = import_react6.default.memo(function(r17) {
  var t12 = r17.hue, n6 = r17.onChange, o12 = g4(["react-colorful__hue", r17.className]);
  return import_react6.default.createElement("div", { className: o12 }, import_react6.default.createElement(m4, { onMove: function(e12) {
    n6({ h: 360 * e12.left });
  }, onKey: function(e12) {
    n6({ h: s5(t12 + 360 * e12.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b4(t12), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react6.default.createElement(p4, { className: "react-colorful__hue-pointer", left: t12 / 360, color: q2({ h: t12, s: 100, v: 100, a: 1 }) })));
});
var T3 = import_react6.default.memo(function(r17) {
  var t12 = r17.hsva, n6 = r17.onChange, o12 = { backgroundColor: q2({ h: t12.h, s: 100, v: 100, a: 1 }) };
  return import_react6.default.createElement("div", { className: "react-colorful__saturation", style: o12 }, import_react6.default.createElement(m4, { onMove: function(e12) {
    n6({ s: 100 * e12.left, v: 100 - 100 * e12.top });
  }, onKey: function(e12) {
    n6({ s: s5(t12.s + 100 * e12.left, 0, 100), v: s5(t12.v - 100 * e12.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b4(t12.s) + "%, Brightness " + b4(t12.v) + "%" }, import_react6.default.createElement(p4, { className: "react-colorful__saturation-pointer", top: 1 - t12.v / 100, left: t12.s / 100, color: q2(t12) })));
});
...
var R2;
var V3 = "undefined" != typeof window ? import_react6.useLayoutEffect : import_react6.useEffect;
var $3 = function() {
...
var U2 = function(t12) {
  var n6 = t12.className, o12 = t12.colorModel, a5 = t12.color, l6 = void 0 === a5 ? o12.defaultColor : a5, i6 = t12.onChange, s6 = c5(t12, ["className", "colorModel", "color", "onChange"]), f5 = (0, import_react6.useRef)(null);
  Q(f5);
  var v5 = Y2(o12, l6, i6), d5 = v5[0], h5 = v5[1], m5 = g4(["react-colorful", n6]);
  return import_react6.default.createElement("div", u4({}, s6, { ref: f5, className: m5 }), import_react6.default.createElement(T3, { hsva: d5, onChange: h5 }), import_react6.default.createElement(S3, { hue: d5.h, onChange: h5, className: "react-colorful__last-control" }));
};
var ee = function(r17) {
  ...
  return import_react6.default.createElement("div", { className: l6 }, import_react6.default.createElement("div", { className: "react-colorful__alpha-gradient", style: a5 }), import_react6.default.createElement(m4, { onMove: function(e12) {
    o12({ a: e12.left });
  }, onKey: function(e12) {
    o12({ a: s5(n6.a + e12.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u5 + "%", "aria-valuenow": u5, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react6.default.createElement(p4, { className: "react-colorful__alpha-pointer", left: n6.a, color: k4(n6) })));
};
var re = function(t12) {
  var n6 = t12.className, o12 = t12.colorModel, a5 = t12.color, l6 = void 0 === a5 ? o12.defaultColor : a5, i6 = t12.onChange, s6 = c5(t12, ["className", "colorModel", "color", "onChange"]), f5 = (0, import_react6.useRef)(null);
  Q(f5);
  var v5 = Y2(o12, l6, i6), d5 = v5[0], h5 = v5[1], m5 = g4(["react-colorful", n6]);
  return import_react6.default.createElement("div", u4({}, s6, { ref: f5, className: m5 }), import_react6.default.createElement(T3, { hsva: d5, onChange: h5 }), import_react6.default.createElement(S3, { hue: d5.h, onChange: h5 }), import_react6.default.createElement(ee, { hsva: d5, onChange: h5, className: "react-colorful__last-control" }));
};
var xe = { defaultColor: { r: 0, g: 0, b: 0, a: 1 }, toHsva: L2, fromHsva: I3, equal: F2 };
var Ce = function(r17) {
  return import_react6.default.createElement(re, u4({}, r17, { colorModel: xe }));
};
...
var Ne = function(r17) {
  return import_react6.default.createElement(U2, u4({}, r17, { colorModel: Me }));
};
  ...
  return [{
    ...
    accept: Array.isArray(accept) ? (
      ...
      accept.filter(function(item) {
        ...
        return _objectSpread(_objectSpread({}, a5), {}, _defineProperty3({}, b5, []));
      }, {})
    ) : {}
  }];
}
...
function _objectSpread3(target) {
  for (var i6 = 1; i6 < arguments.length; i6++) {
    var source = null != arguments[i6] ? arguments[i6] : {};
    i6 % 2 ? ownKeys4(Object(source), true).forEach(function(key) {
...
function useValuesForPath(store, paths, initialData) {
  const valuesForPath = store.useStore((s6) => {
    const data = _objectSpread22(_objectSpread22({}, initialData), s6.data);
...
function usePopin(margin = 3) {
  ...
  const hide = (0, import_react9.useCallback)(() => setShow(false), []);
  (0, import_react9.useLayoutEffect)(() => {
    if (shown) {
      const {
        bottom,
...
var format$12 = (v5, settings) => {
  return convert2(w3(v5), _objectSpread22(_objectSpread22({}, settings), {}, {
    isString: true,
    format: "hex"
  }));
};
...
function Joystick({
  ...
  return import_react9.default.createElement(JoystickTrigger, _extends2({
    ref: joystickeRef
...
function ImageComponent() {
  ...
  const clear = (0, import_react9.useCallback)((e12) => {
    e12.stopPropagation();
    onUpdate(void 0);
  }, [onUpdate]);
  const {
...
var sanitize2 = (value, {
  ...
  return [clamp2(Number(min), MIN, Math.max(MIN, max)), clamp2(Number(max), Math.min(MAX, min), MAX)];
};
var normalize2 = ({
  value,
  min,
...
function IntervalSlider(_ref) {
  ...
  return import_react9.default.createElement(RangeWrapper, _extends2({
    ref
...
function IntervalComponent() {
  ...
  return import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement(Row, {
    input: true
  }, import_react9.default.createElement(Label, null, label), import_react9.default.createElement(Container2, null, import_react9.default.createElement(IntervalSlider, _extends2({
    value: displayValue
  }, settings, {
    onDrag: onUpdate
  })), import_react9.default.createElement(Vector, {
...
var MonitorCanvas = (0, import_react9.forwardRef)(function({
  ...
  const min = (0, import_react9.useRef)(initialValue);
  const max = (0, import_react9.useRef)(initialValue);
...
var MonitorLog = (0, import_react9.forwardRef)(function({
  ...
  const [val, set] = (0, import_react9.useState)(parse2(initialValue));
  (0, import_react9.useImperativeHandle)(ref, () => ({
    frame: (v5) => set(parse2(v5))
  }), []);
...
var Control = import_react9.default.memo(({
  ...
  if (type in SpecialInputs) {
    ...
    return import_react9.default.createElement(SpecialInputForType, _extends2({
      label,
      path
    }, inputProps));
  }
  ...
  return import_react9.default.createElement(ControlInput, _extends2({
    key: storeId + path,
    type,
    label,
    storeId,
...
function TitleWithFilter({
  ...
  return import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement(StyledTitleWithFilter, {
    ...
    width: 12,
    height: 8
  })), import_react9.default.createElement(TitleContainer, _extends2({}, drag ? bind() : {}, {
    drag,
    filterEnabled
...
function LevaRoot(_ref) {
  ...
  return import_react9.default.createElement(ThemeContext.Provider, {
    value: themeContext
  }, import_react9.default.createElement(LevaCore, _extends2({
    store
  }, props3, {
...
function Leva(_ref) {
  ...
  return import_react9.default.createElement(LevaRoot, _extends2({
    store: levaStore
  }, props3));
}
