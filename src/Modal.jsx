            ...
            <div className="modal-scroll-container">
                ...
                <div className="text_modale_div" id="catacombes_div">
                    <div className="text_catacombes_page" >
                        ...
                        <h4 className="title_modale_presentation">Visites en 3D et VR</h4>
                        <div className="div_video_catacombes">
                            <img src="https://devxr.fr/assets/images/catacombes/oculus_screen_guerinet_catacombes.jpg" alt="" />
                        ...
                        <div className="div_text_under_images">
                            <p>Naviguez à travers les catacombes directement depuis votre navigateur web, avec une expérience totalement en 3D. Pour une immersion encore plus profonde, utilisez un casque de réalité virtuelle.</p>
                            <p>Explorez chaque recoin comme si vous y étiez, ressentez l'ambiance unique et découvrez les secrets enfouis sous la ville lumière.</p>
                        </div>
                        ...
                        <div className="third_div_video_text">
                            ...
                            <video src="https://devxr.fr/assets/video/demo_telephone_realite_augmentee.mp4"></video>
                            <span>
                                <img src="http://devxr.fr/assets/images/catacombes/qr_cabinet_old.png" alt="" />
                                <img src="http://devxr.fr/assets/images/catacombes/qr_guerinet.png" alt="" />
                            </span>
                        </div>
